...
val specInfos = listOf(
    Triple("com.jetbrains.kmpapp.api.pokeapi", "https://raw.githubusercontent.com/PokeAPI/pokeapi/refs/heads/master/openapi.yml", "pokeapi.yaml"),
    Triple("com.jetbrains.kmpapp.api.neows", "https://api.apis.guru/v2/specs/neowsapp.com/1.0/openapi.json", "neows.json"),
)
